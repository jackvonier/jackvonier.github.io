...
// /https://jsbin.com/hakagovufe/1/edit?js,console
...
/////////////////////////////////////////////////////////
//I don't get the one above, I need to work on it more!//
/////////////////////////////////////////////////////////
...
_.map = function(col, fn){
    ...
    if (Array.isArray(col)){
        for(let i = 0; i < col.length; i++){
            arr.push(fn(col[i],i,col));
        }
    }else{
        for(let key in col){
            arr.push(fn(col[key],key,col));
        }
    }
    return arr;
};
